const ICONES = {
  ...
  operations: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 7h11"/><path d="M3 12h8"/><path d="M3 17h6"/><path d="M16 15l2 2 4-5"/><circle cx="17" cy="8" r="3"/></svg>',
  historique: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 12a9 9 0 1 0 3-6.7"/><path d="M3 4v5h5"/><path d="M12 7v5l3 2"/></svg>',
...
export const NAV_ITEMS = [
  ...
  { groupe: "Flux", id: "operations", label: "Opérations", roles: ["agent", "admin", "super_admin"] },
  { groupe: "Flux", id: "historique", label: "Historique des commandes", roles: ["agent", "admin", "super_admin"] },
